...
class KickTab(ttk.Frame):
    def __init__(self, parent, main_window):
        ...
        self.create_slider(synth_frame, "Start Phase (deg)", 0.0, 360.0, 0.0, "phase", "Starting phase of the sine wave (0-360).")
        self.create_slider(synth_frame, "Click/Noise Level", 0.0, 3.0, 1.0, "click_level", "Volume of the initial click/transient.")
        self.create_slider(synth_frame, "Click Decay (ms)", 5.0, 100.0, 10.0, "click_decay", "How fast the click fades out.")
        self.create_slider(synth_frame, "Click Width (Stereo)", 0.0, 2.0, 0.0, "click_width", "Stereo width of the click noise (0=Mono, 2=Wide).")

        # --- Effects Tab ---
        self.create_slider(fx_frame, "Saturation Drive (dB)", 0.0, 12.0, 4.5, "drive", "Amount of distortion/saturation applied.")
        self.create_slider(fx_frame, "Reverb Amount", 0.0, 1.0, 0.0, "reverb", "Level of reverb effect.")
        self.create_slider(fx_frame, "Delay Amount", 0.0, 1.0, 0.0, "delay", "Level of delay/echo effect.")
        ...
        # Bass Freq
        self.create_slider(bass_frame, "Bass Frequency (Hz)", 30.0, 100.0, 55.0, "bass_freq", "Fundamental frequency of the bassline.")
        # Sidechain Depth
