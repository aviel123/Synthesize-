...
class KickTab(ttk.Frame):
    def __init__(self, parent, main_window):
        ...
        self.create_slider(synth_frame, "Start Phase (deg)", 0.0, 360.0, 0.0, "phase", tooltip_text="Starting phase of the sub/punch. Adjust for phase alignment.")
        self.create_slider(synth_frame, "Click/Noise Level", 0.0, 3.0, 1.0, "click_level", tooltip_text="Volume of the high-frequency click/noise layer")
        self.create_slider(synth_frame, "Click Decay (ms)", 5.0, 100.0, 10.0, "click_decay", tooltip_text="Length of the click/noise envelope")
        self.create_slider(synth_frame, "Click Width (Stereo)", 0.0, 2.0, 0.0, "click_width", tooltip_text="Stereo width of the click layer (0=Mono, 1=Stereo, >1=Wide)")

        # --- Effects Tab ---
        self.create_slider(fx_frame, "Saturation Drive (dB)", 0.0, 12.0, 4.5, "drive", tooltip_text="Amount of soft-clipping distortion")
        self.create_slider(fx_frame, "Reverb Amount", 0.0, 1.0, 0.0, "reverb", tooltip_text="Mix amount for the reverb tail")
        self.create_slider(fx_frame, "Delay Amount", 0.0, 1.0, 0.0, "delay", tooltip_text="Mix amount for the ping-pong delay")
        ...
        # Bass Freq
        self.create_slider(bass_frame, "Bass Frequency (Hz)", 30.0, 100.0, 55.0, "bass_freq", tooltip_text="Pitch of the accompanying bassline")
        # Sidechain Depth
        self.create_slider(bass_frame, "Sidechain Depth", 0.0, 1.0, 0.8, "sc_depth", tooltip_text="Amount of volume reduction on the bass when kick hits")
