...
class KickTab(ttk.Frame):
    def __init__(self, parent, main_window):
        ...
        self.create_slider(synth_frame, "Duration (s)", 0.1, 1.0, 0.5, "duration", tooltip_text="Total length of the kick in seconds.")
        self.create_slider(synth_frame, "Start Phase (deg)", 0.0, 360.0, 0.0, "phase", tooltip_text="Adjusts the phase alignment of the sub/punch (0-360 degrees).")
        self.create_slider(synth_frame, "Click/Noise Level", 0.0, 3.0, 1.0, "click_level", tooltip_text="Volume of the high-frequency 'click' transient.")
        self.create_slider(synth_frame, "Click Decay (ms)", 5.0, 100.0, 10.0, "click_decay", tooltip_text="Duration of the click transient in milliseconds.")
        self.create_slider(synth_frame, "Click Width (Stereo)", 0.0, 2.0, 0.0, "click_width", tooltip_text="Stereo width of the click (0=Mono, 1=Normal, 2=Wide).")

        # --- Effects Tab ---
        self.create_slider(fx_frame, "Saturation Drive (dB)", 0.0, 12.0, 4.5, "drive", tooltip_text="Amount of soft-clipping distortion (dB).")
        self.create_slider(fx_frame, "Reverb Amount", 0.0, 1.0, 0.0, "reverb", tooltip_text="Mix level of the reverb tail.")
        self.create_slider(fx_frame, "Delay Amount", 0.0, 1.0, 0.0, "delay", tooltip_text="Mix level of the stereo ping-pong delay.")
        ...
        # Bass Freq
        self.create_slider(bass_frame, "Bass Frequency (Hz)", 30.0, 100.0, 55.0, "bass_freq", tooltip_text="Fundamental frequency of the bassline (Hz).")
        # Sidechain Depth
        self.create_slider(bass_frame, "Sidechain Depth", 0.0, 1.0, 0.8, "sc_depth", tooltip_text="Amount of volume reduction on the bass when the kick hits.")
