...
class KickTab(ttk.Frame):
    def __init__(self, parent, main_window):
        ...
        self.create_slider(bass_frame, "Bass Frequency (Hz)", 30.0, 100.0, 55.0, "bass_freq",
                           tooltip_text="Fundamental frequency of the bassline")
        # Sidechain Depth
        ...
        ToolTip(trigger_btn, "Exports a short click audio file to use as a sidechain trigger source in your DAW")
